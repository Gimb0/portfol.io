...
import OwnedShareSelect from './../Components/js/OwnedShareSelect';
...
class SellShare extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            errors: "",
            ...
            <GridWrapper>
                ...
                <div className="container-login100">
                    <div className="wrap-login100">
                        ...
                        <form className="login100-form" onSubmit={(e) => this.SellShare(e)}>
                            ...
                            <div className="wrap-input100">
                                <input className="input100" name="totalPrice" type="text" placeholder="Enter the total selling price" />
                            </div>
                            <div className="errorMessage">{unitsMessage}</div>
                            <div className="wrap-input100">
                                <input className="input100" name="units" type="text" placeholder="Enter the total number of units sold" />
                            </div>
                            <div className="container-login100-form-btn">
                                <input className="login100-form-btn" type="submit" value="Sell Share" />
                            </div>
                        </form>
                    </div>
                </div>
